{
  ...
  "metadata": {
    "colab": {
      "provenance": [],
      "authorship_tag": "ABX9TyNMfXua7u9PHFUuQ6AkdLB4",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/mypotato20-ops/income_tax.py/blob/main/%ED%8C%80%EC%9B%90%EC%9D%BC%EC%A0%95%EA%B3%B5%EC%9C%A0.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
      ...
      "metadata": {
        ...
        "id": "4-0ubs42MlS2",
        "outputId": "0546828d-eb3a-43e6-d7fe-eb385c871f99"
      },
      "outputs": [
        {
          "output_type": "error",
