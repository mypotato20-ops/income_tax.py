{
  ...
  "metadata": {
    "colab": {
      "provenance": [],
      "authorship_tag": "ABX9TyMluACaZLK0r7OFyk92uxFP",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/mypotato20-ops/income_tax.py/blob/main/%ED%8C%80%EC%9B%90%EC%9D%BC%EC%A0%95%EA%B3%B5%EC%9C%A01.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
      ...
      "metadata": {
        ...
        "id": "4-0ubs42MlS2",
        "outputId": "0a33a42b-6b22-49ac-90d8-92d8693ac189"
      },
      "outputs": [
        {
          "output_type": "error",
      ...
      "source": [
        ...
        "import os\n",
        "\n",
        "# utils 모듈 임포트를 위한 경로 추가\n",
        "sys.path.append(os.path.dirname(os.path.abspath(__file__)))\n",
        "\n",
        "from utils.data_manager import (\n",
        "    load_members, save_members, load_schedules, save_schedules,\n",
        "    add_schedule, delete_schedule, add_member, get_member_by_id,\n",
        "    check_conflicts, get_statistics\n",
        ")\n",
        "\n",
        "# 페이지 설정\n",
        "st.set_page_config(\n",
        ...
        "with col1:\n",
        "    if st.button(\"📅 캘린더\", use_container_width=True, type=\"primary\" if st.session_state.view == 'calendar' else \"secondary\"):\n",
        "        st.session_state.view = 'calendar'\n",
        "        st.rerun()\n",
        "\n",
        "with col2:\n",
        "    if st.button(\"📊 통계\", use_container_width=True, type=\"primary\" if st.session_state.view == 'stats' else \"secondary\"):\n",
        "        st.session_state.view = 'stats'\n",
        "        st.rerun()\n",
        "\n",
        "with col3:\n",
        "    if st.button(\"👥 팀원 관리\", use_container_width=True, type=\"primary\" if st.session_state.view == 'members' else \"secondary\"):\n",
        ...
        "        with col2:\n",
        "            if st.button(\"✕\", key=f\"close_notif_{i}\"):\n",
        ...
        "    # 컨트롤 바\n",
        "    col1, col2, col3, col4, col5, col6, col7 = st.columns([1, 1, 1, 2, 2, 2, 3])\n",
        "\n",
        "    with col1:\n",
        ...
        "\n",
        "                    # 일정 표시\n",
        "                    for schedule in day_schedules[:3]:  # 최대 3개만 표시\n",
        ...
        "                        st.caption(f\"+{len(day_schedules) - 3}개 더\")\n",
        "\n",
        "                    current_day += 1\n",
        "                else:\n",
        "                    st.markdown(\"&nbsp;\")\n",
        ...
        "                {'유형': k, '개수': v}\n",
        "                for k, v in stats['type_count'].items()\n",
        "            ])\n",
        ...
        "\n",
        "        # CSV 다운로드\n",
        "        csv = df[['날짜', '팀원', '유형', '사유']].to_csv(index=False, encoding='utf-8-sig')\n",
        "        st.download_button(\n",
        "            label=\"📥 CSV 다운로드\",\n",
        "            data=csv,\n",
        "            file_name=f\"팀일정_{datetime.now().strftime('%Y%m%d')}.csv\",\n",
        "            mime=\"text/csv\"\n",
        "        )\n",
        "    else:\n",
        "        st.info(\"등록된 일정이 없습니다.\")\n",
        ...
        "        with col1:\n",
        "            st.markdown(\n",
        "                f'<div style=\"width: 30px; height: 30px; background-color: {member[\"color\"]}; border-radius: 5px;\"></div>',\n",
        "                unsafe_allow_html=True\n",
        "            )\n",
        "\n",
        "        with col2:\n",
        ...
        "        with col4:\n",
        "            remaining = member['total_leave'] - member['used_leave']\n",
        "            st.caption(f\"남은 연차: {remaining}일\")\n",
        "\n",
        "    st.markdown(\"---\")\n",
        "\n",
        "    # 팀원 추가\n",
        ...
        "st.markdown(\"---\")\n",
        "st.markdown(\n",
        "    f\"<div style='text-align: center; color: gray;'>팀 일정 관리 시스템 v1.0 | 마지막 업데이트: {datetime.now().strftime('%Y-%m-%d %H:%M')}</div>\",\n",
        "    unsafe_allow_html=True\n",
        ")\n"
      ]
    },
